...
const HeroSection = () => {
  ...
  const getVisibleVideos = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 w-full">      {/* Header Tagline */}
      ...
      </div>      {/* Carousel Section - Always shows 3 images with pop-up effect */}
      <div
      ...
      >        <div className={`w-full px-4 md:px-8 ${hasAnimated ? 'animate-slowPopUp' : 'opacity-0'}`} style={{ animationDuration: '1.4s', animationDelay: '500ms', animationFillMode: 'both' }}>
          <div className="flex justify-center items-center gap-4 md:gap-6 lg:gap-8">
            {getVisibleVideos().map((video, index) => (
              <div key={video.key} className="relative flex-shrink-0 carousel-video-wrapper">                <div className="w-[280px] h-[180px] sm:w-[320px] sm:h-[200px] md:w-[360px] md:h-[225px] lg:w-[400px] lg:h-[250px] xl:w-[420px] xl:h-[260px] overflow-hidden shadow-xl rounded-lg">
                <video
                  src={video.src}
